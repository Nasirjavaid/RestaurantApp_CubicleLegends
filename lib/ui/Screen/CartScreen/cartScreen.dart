...
/////////////////////////////////////////////////////////////////
    ...
    return BlocProvider(create: (context) {
      ...
      builder: (context, state) {
        ...
        if (state is UserProfiledetailTakenSuccessfully) {
          userLoginForCartOrderSubmission = UserLogin();
          print(
  ...
  Widget deliveryOptionsDropDownList(
    ...
    try {
      ...
      print("Exception in crt screen $ex");
    }
          ...
          if (deliveryOptions == null || deliveryOptions == "") {
            ...
            if (shipingAddressSwitch) {
              ...
              if (etName.text == null || etName.text == "") {
                ...
                userLoginForCartOrderSubmission.data.customerName = etName.text;
                userLoginForCartOrderSubmission.data.customerPhone =
                    etPhone.text;
                userLoginForCartOrderSubmission.data.customerEmail =
                    etEmail.text;
                userLoginForCartOrderSubmission.data.favoriteDeliveryAddress =
                    etAddress.text;
...
//this will be called when ever the this state willl come
          BlocProvider.of<CartBloc>(context)
              .add(FoodProductTotalBillCartEvent(index: shippingInfoListIndex));
