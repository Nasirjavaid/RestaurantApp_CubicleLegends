...
class CartaddonsUpdatingDialogue extends StatefulWidget {
  ...
  CartaddonsUpdatingDialogue(
      {this.foodinfo, this.contextA, this.shippingInfoListIndex});
        ...
        child: Container(
          ...
          child: MaterialButton(
              ...
              onPressed: () async {
                ...
                ////////////////////////////////////////////////////////////////dd
                BlocProvider.of<CartBloc>(widget.contextA)
                    .add(FoodProductTotalBillCartEvent(index: widget.shippingInfoListIndex));
