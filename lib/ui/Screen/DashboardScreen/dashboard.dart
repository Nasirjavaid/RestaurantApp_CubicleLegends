      ...
      child: GridView.count(
        ...
        children: List.generate(foodInfoList.length, (index) {
          return Card(
            ...
            child: InkWell(
              onTap: () {
                addProductToCart(foodProduct.data.foodinfo[index]);
              },
              child: Stack(
                children: [
                  RoundedCornerImageViewWithoutBorderDynamic(
                    ...
                    imageLink: foodProduct.data.foodinfo[index].productImage ==
                            "http://unique-itsolutions.co.uk/restaurant-demo/new/"
...
//////////////////////////////////////////////////////////////////////
  ...
  Widget singleWidgetImageProduct(
    ...
    return InkWell(
      onTap: () {
        addProductToCart(singleFoodinfo);
      },
      child: Padding(
        ...
        child: Card(
          ...
          child: Stack(children: [
            RoundedCornerImageViewWithoutBorderDynamic(
              ...
              width: MediaQuery.of(context).size.width,
              cornerRadius: 5,
              imageLink: singleFoodinfo.productImage ==
                      "http://unique-itsolutions.co.uk/restaurant-demo/new/"
                  ? "https://ozersky.tv/wp-content/uploads/2018/02/hamburger-7.jpg"
...
//////////////////////////////////////////////////////////////////////
  ...
  void addProductToCart(Foodinfo foodinfo) {
...
///////////////////////////////////////////////////////////////////
      ...
      Methods.showDialogMenuListAddons(context, foodinfo);
    }
  }
}
