...
class AddonsDialogue extends StatefulWidget {
  ...
  AddonsDialogue({this.foodinfo, this.contextA}) {
...
///////////////////////////////////////////////////////////////////
                        ...
                        Text(
                          "Price: ${widget.foodinfo.foodPerItemTtotalPrice}",
                          style: Theme.of(context)
                              .textTheme
                              .bodyText1
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                "Rs. ${addOnsListTotalPrice + widget.foodinfo.foodPerItemTtotalPrice}.00",
                style: Theme.of(context)
                    .textTheme
                    .bodyText1
                    .copyWith(fontSize: 14),
