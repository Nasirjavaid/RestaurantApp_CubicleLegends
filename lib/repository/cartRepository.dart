...
//               foodPriceCoversionFromStringToDouble.toInt();
      ...
      print("Erroe while geeting data from shared prefrences : $ex");
      return foodinfoList;
    }
  }
...
// adding addons list
    ...
    OrderPlacingResponceModel orderPlacingResponceModel = await cartService.placeOrder(
        userLogin, foodInfoListFromCart, orderPlacingModelList);
